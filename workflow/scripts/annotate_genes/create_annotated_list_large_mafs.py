...
write_df_to_fasta(
    ...
    "scratch/blast_query_proteins/query_vertebrate_MAFL.faa"
)
...
write_df_to_fasta(
    ...
    "scratch/blast_query_proteins/query_invertebrate_MAFL.faa"
)

write_df_to_fasta(
    annotated_mafs.query("IsVertebrate == 'Yes'").query("GeneGroup == 'CMAF'"),
    "scratch/blast_query_proteins/query_vertebrate_CMAF.faa"
)

write_df_to_fasta(
    annotated_mafs.query("IsVertebrate == 'Yes'").query("GeneGroup == 'MAFA'"),
    "scratch/blast_query_proteins/query_vertebrate_MAFA.faa"
)

write_df_to_fasta(
    annotated_mafs.query("IsVertebrate == 'Yes'").query("GeneGroup == 'MAFB'"),
    "scratch/blast_query_proteins/query_vertebrate_MAFB.faa"
)

write_df_to_fasta(
    annotated_mafs.query("IsVertebrate == 'Yes'").query("GeneGroup == 'NRL'"),
    "scratch/blast_query_proteins/query_vertebrate_NRL.faa"
)
