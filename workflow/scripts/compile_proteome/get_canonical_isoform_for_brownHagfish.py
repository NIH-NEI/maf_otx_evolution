    ...
    for gtf in gtf_paths:
        ...
        with open(gtf, "r") as fh:
            for line in fh:
                ...
                if ftype == "gene":
                    gid = attrs.get("gene_id") or attrs.get("locus_tag") or attrs.get("Name") or attrs.get("gene")
                    if gid:
                        # Best-effort store a symbol for nicer headers
                        sym = attrs.get("gene") or attrs.get("gene_name") or attrs.get("locus_tag") or gid
